        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Participant1Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Participant2Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MedicalAssociationId = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Psychiatrists", x => x.UserId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedsReminderTypes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Alarm = table.Column<TimeSpan>(type: "time", nullable: false),
                    PatientUserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedsReminders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedsReminders_Patients_PatientUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Alarm = table.Column<TimeOnly>(type: "time", nullable: false),
                    PatientUserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VisitReminders", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VisitReminders_Patients_PatientUserId",
                        column: x => x.PatientUserId,
                        principalTable: "Patients",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedsReminders_PatientUserId",
                table: "MedsReminders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VisitReminders_PatientUserId",
                table: "VisitReminders",
                column: "PatientUserId");
        }
