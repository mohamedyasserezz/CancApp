...
namespace CanaApp.Persistance.Data.Migrations
{
    ...
    [Migration("20250615121115_AddFCMTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CanaApp.Domain.Entities.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NumberOfWarrings = 0,
                            PasswordHash = "AQAAAAIAAYagAAAAEJIejaKR5/K1FkC33XcEeSrqbM9huWSGWYyJu7Mz7vzv1FMlVSkdgXRmxheTle2MJQ==",
                        ...
                        new
                        {
                            ...
                            NumberOfWarrings = 0,
                            PasswordHash = "AQAAAAIAAYagAAAAENGITEBMVsht5DctMR5D/RYwg0VpU6QkkpPk5SBAQty4eWx0k48hHWS8b3Ba5a96PA==",
                            PhoneNumberConfirmed = false,
                        ...
                        new
                        {
                            ...
                            NumberOfWarrings = 0,
                            PasswordHash = "AQAAAAIAAYagAAAAEGqR6OQ2cuLNIrGDgx2O0ztD08hr4uQr4P+O+eGp5pJ8uLi4P5onSe0SOuhAYP4JqA==",
                            PhoneNumberConfirmed = false,
            ...
            modelBuilder.Entity("CanaApp.Domain.Entities.Records.RecordAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RecordAccessRequests");
                });
            ...
            modelBuilder.Entity("CanaApp.Domain.Entities.Models.ApplicationUser", b =>
                {
                    b.OwnsMany("CanaApp.Domain.Entities.Models.FcmToken", "FcmTokens", b1 =>
                        {
                            ...
                            b1.ToTable("FcmTokens", (string)null);
            ...
            modelBuilder.Entity("CanaApp.Domain.Entities.Records.RecordAccess", b =>
                {
                    b.HasOne("CanaApp.Domain.Entities.Models.ApplicationUser", "Doctor")
                        .WithMany()
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CanaApp.Domain.Entities.Models.ApplicationUser", "Patient")
                        .WithMany()
