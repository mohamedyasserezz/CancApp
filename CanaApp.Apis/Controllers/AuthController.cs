...
namespace CanaApp.Apis.Controllers
{
        ...
        ILogger<AuthController> logger) : ControllerBase
    {
        ...
        public async Task<IActionResult> CompletePharmacyRegistration([FromForm] CompleteProfilePharmacyRequest request, CancellationToken cancellationToken)
        {
        ...
        public async Task<IActionResult> CompleteDoctorRegistration([FromForm] CompleteProfileDoctorRequest request, CancellationToken cancellationToken)
        {
